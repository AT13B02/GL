...
// コンストラクタ
//=============================================================================
CIcon2D::CIcon2D(CInterfaceManager* interface_manager , s32 player_id , f32 scale )
{
